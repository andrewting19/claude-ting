...
| **Claude or Codex TUI redraws badly after resize** | Refresh your shell helper from `setup-claude-codex.sh`; the Docker helpers now run `stty opost onlcr` before launching the CLI |
