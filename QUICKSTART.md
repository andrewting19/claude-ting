...
| **Claude or Codex redraws badly after resize** | Refresh the Docker helpers from `setup-claude-codex.sh`; they now normalize tty output before launching the CLI |
