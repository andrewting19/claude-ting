...
echo ""
echo "Next steps:"
echo "  1. Build the gateway server:"
echo "     cd gateway-server"
echo "     docker build -t dev-sessions-gateway ."
echo ""
echo "  2. Start the gateway server:"
echo "     docker run -d \\"
echo "       --name dev-sessions-gateway \\"
echo "       -p 6767:6767 \\"
...
echo ""
echo "  3. Install the MCP client:"
echo "     cd dev-sessions-mcp"
echo "     npm install"
echo "     npm run build"
echo "     npm link"
echo ""
